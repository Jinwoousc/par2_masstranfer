    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Export all mass fields in a csv file.
        *        WARNING: this function is computationally expensive
        *        and should be avoided if computation time is critical.
        * @param fileName Path to the csv file
        */
        void massexportCSV(const std::string &fileName) const;
    ...
    private:
        ...
        // Velocity field stored on device (facefield)
        thrust::device_vector<int> mmb1;
        thrust::device_vector<int> mmb2;
        thrust::device_vector<int> mimb1;
        thrust::device_vector<int> mimb2;
        // Particle positions stored on device
        thrust::device_vector<T> cx;
        thrust::device_vector<T> cy;
        thrust::device_vector<T> cz;
        thrust::device_vector<int> cp;
        thrust::device_vector<T> cm;
